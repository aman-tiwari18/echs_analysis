...
queries = {
    ...
    "02_Simultaneous_Admissions": """
        ...
        LEFT JOIN office_master om1 ON a.CI_HOSPITAL_ID = om1.OM_OFFICE_ID
        LEFT JOIN office_master om2 ON b.CI_HOSPITAL_ID = om2.OM_OFFICE_ID
    ...
    "03_Duplicate_Bill_Numbers": """
        SELECT 
            ...
            GROUP_CONCAT(DISTINCT CONCAT(ci.CI_HOSPITAL_ID, ':', COALESCE(om.OM_OFFICE_NAME, 'Unknown')) ORDER BY ci.CI_HOSPITAL_ID SEPARATOR ' | ') as hospitals,
            GROUP_CONCAT(DISTINCT CONCAT(crm.CRM_CITY_NAME, '-', sm.SM_STATE_NAME) ORDER BY crm.CRM_CITY_NAME SEPARATOR ' | ') as locations,
